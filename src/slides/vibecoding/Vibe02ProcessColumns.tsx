...
export const Vibe02ProcessColumns = () => {
  return (
    <div className="h-full w-full p-16 flex flex-col">
      <AnimatedBlock delay={0.1}>
        <h2 className="text-8xl font-serif italic mb-12 text-retro-text">СТАРЫЙ ПРОЦЕСС</h2>
      </AnimatedBlock>
      ...
      <div className="flex-1 flex items-end justify-center gap-12">
        ...
        <AnimatedBlock delay={0.3} className="flex flex-col items-center flex-1 max-w-[280px]">
          <div className="w-full bg-retro-dim/20 border border-retro-dim/40 rounded-t-[2rem] h-[22vh] mb-4" />
          <div className="h-16 flex items-center justify-center w-full">
        ...
        <AnimatedBlock delay={0.4} className="flex flex-col items-center flex-1 max-w-[280px]">
          <div className="w-full bg-retro-text text-retro-bg border border-retro-text rounded-t-[2rem] h-[58vh] mb-4" />
          <div className="h-16 flex items-center justify-center w-full">

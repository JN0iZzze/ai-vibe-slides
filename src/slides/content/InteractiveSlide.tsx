...
const SYSTEM_PROMPT = `Ты эксперт по карьерному развитию. Проанализируй прошлые профессии аудитории. Объясни, как КОНКРЕТНО их навыки делают их уникальными дизайнерами в эпоху ИИ. Приведи примеры синергии. Кратко, персонализированно, вдохновляюще. Максимум 280 символов. Выделяй главное жирным.`;
...
export const InteractiveSlide: React.FC = () => {
  const { sessionId, pollId } = useSession();
  ...
  return (
    <div className="h-full w-full relative overflow-hidden flex flex-col items-center justify-center">
      ...
      {/* <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vw] bg-retro-accent/5 rounded-full blur-[100px]" />
      </div> */}
      ...
      <div className="flex flex-col items-center justify-center z-50 relative px-16">
        <AnimatedBlock delay={0.3} direction="up">
          <h1 className="font-serif text-6xl mb-12 text-center text-retro-text max-w-5xl leading-tight">
            Из какой сферы пришли в&nbsp;дизайн?
          </h1>
        </AnimatedBlock>

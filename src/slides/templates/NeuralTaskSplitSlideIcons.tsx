...
export const NeuralTaskSplitSlideIcons: React.FC = () => {
  return (
    <div className="h-full w-full p-10 flex flex-col gap-6 overflow-hidden">
      ...
      {/* Нижняя часть: Карточки с иконками */}
      <div className="h-64 shrink-0">
        <AnimatedBlock delay={0.4} className="h-full flex gap-4">
          <div className="flex-1 min-w-0 bg-retro-text text-retro-bg rounded-[2rem] p-5 flex flex-col justify-between relative overflow-hidden">
            <div className="p-4 bg-retro-bg/20 rounded-full w-fit shrink-0">
          ...
          <div className="flex-1 min-w-0 border border-retro-dim rounded-[2rem] p-5 flex flex-col justify-between">
            <div className="p-3 bg-retro-text/10 rounded-full w-fit shrink-0">
              <Sparkles size={36} />
            </div>
            <div>
